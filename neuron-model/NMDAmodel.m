function [spiketimes inputs] = NMDAmodel(modFreq, g_syn1, g_syn2, g_l)
...
% activation gating of Na current is instantaneous function of voltage
    ...
    tau_d2=65; tau_r2=3.5; % time constants for decay and rise of synaptic current (ms)
